                ...
                if($everyThingOK)
                {
                        ...
                        else
                        {
                                ...
                                */
                                ...
                                VALUES('$name','$father_name','$cnic','$u_name','$pass','$email','','$gender','admin','$phone_p','','$city','$province','$address','1','0','0','0','0','0')";
...
<div class="container">
    ...
    <form class="two_row_form" action="admin_account.php" method="post">
            ...
            <button type="submit" class="btn btn-success" name="admin_account">Create Account</button>
    </form>
