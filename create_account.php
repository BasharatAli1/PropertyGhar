...
$everyThingOK = true;
$phone_p_id = $address_id = $cnic = "";
$name_err = $u_name_err = $pass_err = $phone_err = $city_err = $province_err = $address_err = $gender_err = "";
...
if(isset($_POST["create_account"]))
{
        ...
        if($connection)
        {
                ...
                if (empty($_POST["name"])||empty($_POST["userName"])||empty($_POST["password"])||empty($_POST["city"])||empty($_POST["province"])||empty($_POST["address"]))
                {
                        ?>
                        <div class="container">
                        <div class="row">
                ...
                if($everyThingOK)
                {
                        ...
                        else
                        {
                                ...
                                */
                                ...
                                VALUES('$name','','$cnic','$u_name','$pass','$email','','$gender','user','$phone_p','','$city','$province','$address','1','0','0','0','0','0')";
...
<div class="container">
    ...
    <form class="two_row_form" action="create_account.php" method="post">
